...
env.IGNORE_LIST = ["All-Users","aaa","config","c3po","dhcpl2relay","foo-app","fpcagent","freeDiameter","fwaas","igmp","igmpproxy","kolla","kolla-ansible","lbaas","mcast","mcord-configs","olt","vtn","sadis","voltha","voltha-bal","voltha-omci","qa-manifest"]
